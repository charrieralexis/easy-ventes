...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'easyventes', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\EasyVentes\\FrontBundle\\Entity'))), 'EasyVentes\\FrontBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('EasyVentesFrontBundle' => 'EasyVentes\\FrontBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_86776a01c2ba0297605eced86665b64156a9ee0d5a6e338c1858b6ab317d1151');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('EasyVentes\\FrontBundle\\Entity\\Client');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('EasyVentes\\FrontBundle\\Entity\\Client');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('EasyVentes\\FrontBundle\\Entity\\Client');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('EasyVentes\\FrontBundle\\Entity\\Client');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'EasyVentes\\FrontBundle\\Entity\\Client');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => ':form:fields.html.twig'), 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => ':form:fields.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\EasyVentes\\FrontBundle/Resources/views'), 'EasyVentesFront');
        $instance->addPath(($this->targetDirs[3].'\\src\\EasyVentes\\BackBundle/Resources/views'), 'EasyVentesBack');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ef2b6b352cb05c06b1d09cd07b1c4b8b09ef0af9');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EasyVentesFrontBundle' => 'EasyVentes\\FrontBundle\\EasyVentesFrontBundle',
                'EasyVentesBackBundle' => 'EasyVentes\\BackBundle\\EasyVentesBackBundle',
            ...
            'locale' => 'fr',
            'secret' => 'ef2b6b352cb05c06b1d09cd07b1c4b8b09ef0af9',
            ...
            'kernel.secret' => 'ef2b6b352cb05c06b1d09cd07b1c4b8b09ef0af9',
            ...
            'fos_user.model.user.class' => 'EasyVentes\\FrontBundle\\Entity\\Client',
